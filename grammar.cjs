...
var grammar = {
    ...
    {"name": "code", "symbols": [(lexer.has("code") ? {type: "code"} : code), "_", "subInstruction", "code$ebnf$1"], "postprocess": function (d) { return [d[2], findLine(d)]; }},
    ...
    {"name": "type", "symbols": [(lexer.has("doubleArgType") ? {type: "doubleArgType"} : doubleArgType), "type$ebnf$4", "__", "type", "__", "type"], "postprocess": doubleArgKeywordToJson},
    ...
    {"name": "type", "symbols": [(lexer.has("lparen") ? {type: "lparen"} : lparen), "_", (lexer.has("comparableType") ? {type: "comparableType"} : comparableType), "type$ebnf$5", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": comparableTypeToJson},
    ...
    {"name": "type", "symbols": [(lexer.has("lparen") ? {type: "lparen"} : lparen), "_", (lexer.has("constantType") ? {type: "constantType"} : constantType), "type$ebnf$6", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": comparableTypeToJson},
    ...
    {"name": "type", "symbols": [(lexer.has("lparen") ? {type: "lparen"} : lparen), "_", (lexer.has("singleArgType") ? {type: "singleArgType"} : singleArgType), "type$ebnf$7", "__", "type", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": singleArgTypeKeywordWithParenToJson},
    {"name": "type$ebnf$8", "symbols": []},
    {"name": "type$ebnf$8$subexpression$1", "symbols": ["__", (lexer.has("annot") ? {type: "annot"} : annot)]},
    {"name": "type$ebnf$8", "symbols": ["type$ebnf$8", "type$ebnf$8$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "type", "symbols": [(lexer.has("lparen") ? {type: "lparen"} : lparen), "_", (lexer.has("doubleArgType") ? {type: "doubleArgType"} : doubleArgType), "type$ebnf$8", "__", "type", "__", "type", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": doubleArgTypeKeywordWithParenToJson},
    ...
    {"name": "subInstruction$ebnf$2", "symbols": ["subInstruction$ebnf$2$subexpression$1"], "postprocess": id},
    {"name": "subInstruction$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "subInstruction", "symbols": [(lexer.has("lbrace") ? {type: "lbrace"} : lbrace), "_", "subInstruction$ebnf$1", "subInstruction$ebnf$2", (lexer.has("rbrace") ? {type: "rbrace"} : rbrace)], "postprocess": function(d) { return instructionSetToJsonNoSemi(d[2], d[3]); }},
    ...
    {"name": "instruction$ebnf$9$subexpression$1", "symbols": ["__", (lexer.has("annot") ? {type: "annot"} : annot)]},
    {"name": "instruction$ebnf$9", "symbols": ["instruction$ebnf$9", "instruction$ebnf$9$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "instruction", "symbols": [{"literal":"EMPTY_MAP"}, "instruction$ebnf$9", "__", "type", "__", "type"], "postprocess": doubleArgKeywordToJson},
    ...
    {"name": "data$ebnf$1$subexpression$1", "symbols": ["__", (lexer.has("annot") ? {type: "annot"} : annot)]},
    {"name": "data$ebnf$1", "symbols": ["data$ebnf$1", "data$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "data", "symbols": [(lexer.has("doubleArgData") ? {type: "doubleArgData"} : doubleArgData), "data$ebnf$1", "__", "data", "__", "data"], "postprocess": doubleArgKeywordToJson},
    ...
    {"name": "elt$ebnf$1", "symbols": []},
    {"name": "elt$ebnf$1$subexpression$1", "symbols": ["__", (lexer.has("annot") ? {type: "annot"} : annot)]},
    {"name": "elt$ebnf$1", "symbols": ["elt$ebnf$1", "elt$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "elt", "symbols": [(lexer.has("elt") ? {type: "elt"} : elt), "elt$ebnf$1", "_", "data", "_", "data"], "postprocess": doubleArgKeywordToJson},
